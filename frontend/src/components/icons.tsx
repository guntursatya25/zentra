// Shared icon components — Heroicons (outline, 24px) inline to avoid external dependency.
// Each takes an optional className, defaults to h-4 w-4.
...
export function IconThumbUp({ className }: { className?: string }) {
  return (
    <svg className={className || "h-4 w-4"} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.5c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 012.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 00.322-1.672V3a.75.75 0 01.75-.75A2.25 2.25 0 0116.5 4.5c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282h3.126c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285a11.95 11.95 0 01-2.649 7.521c-.388.482-.987.729-1.605.729H13.48c-.483 0-.964-.078-1.423-.23l-3.114-1.04a4.501 4.501 0 00-1.423-.23H5.904M14.25 9h2.25M5.904 18.75c.083.228.22.442.464.574a.75.75 0 00.622.05L8 18l-1.443-.724a.75.75 0 00-.622.05c.244.132.381.346.464.574z" />
    </svg>
  )
}
...
export function IconThumbDown({ className }: { className?: string }) {
  return (
    <svg className={className || "h-4 w-4"} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.498 15.25H4.372c-1.026 0-1.945-.694-2.054-1.715a12.137 12.137 0 01-.068-1.285c0-2.848.992-5.464 2.649-7.521.525-.628 1.127-.875 1.605-.875h3.126c.483 0 .964.078 1.423.23l3.114 1.04a4.501 4.501 0 001.423.23h2.25M14.25 9h-2.25M5.904 18.75c-.083-.228-.22-.442-.464-.574a.75.75 0 00-.622-.05L4 18l1.443-.724a.75.75 0 00.622.05c-.244.132-.381.346-.464.574M18 15.75h3.375c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285 0 2.848-.992 5.464-2.649 7.521-.525.628-1.127.875-1.605.875h-3.126a2.25 2.25 0 01-1.423-.23l-3.114-1.04a4.501 4.501 0 00-1.423-.23h-2.25" />
    </svg>
  )
}
...
export function IconBuilding({ className }: { className?: string }) {
  return (
    <svg className={className || "h-3.5 w-3.5"} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-18v18M3 3h18m0 18H3" />
    </svg>
  )
}
...
export function IconChevronDown({ className }: { className?: string }) {
  return (
    <svg className={className || "h-3 w-3"} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
